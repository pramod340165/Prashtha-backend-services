...
public class SecurityConfiguration {
	 ...
	 * .requestMatchers("/auth/**").permitAll() // Permit access to public URLs
	 * .anyRequest().authenticated() // All other requests require authentication )
	 * .formLogin(form -> form // Enable form-based login .loginPage("/login")
	 * .permitAll() ) .logout(logout -> logout // Enable logout .permitAll() );
	 * return http.build(); }
	 */
